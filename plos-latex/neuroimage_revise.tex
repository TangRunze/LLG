...
For a more specific comparison of the performance of $\hat{P}$ and $\bar{A}$ in the most realistic situation where the rank $d$ must be chosen based on data, Fig.~\ref{fig:corr_re} shows estimated relative efficiencies of $\hat{P}$ versus $\bar{A}$.
